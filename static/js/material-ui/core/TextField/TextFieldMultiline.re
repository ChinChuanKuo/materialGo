open React;
open Setting;
[%bs.raw {|require('../../scss/TextField/textFieldMultiline.scss')|}];
...
let disabledColors = disabledColor =>
  switch (disabledColor) {
  | None => "rgba(0,0,0,0.26)"
  | Some(disabledColor) => disabledColor
  };
  ...
  ReactDOMRe.createDOMElementVariadic(
    ...
    [|
      ...
      ReactDOMRe.createDOMElementVariadic(
        "div",
        ~props=
          ReactDOMRe.domProps(~className="jbr6nlo j7v6wc2 j1p5k45xt", ()),
        [|
          ReactDOMRe.createDOMElementVariadic(
            "textarea",
            ~props=
