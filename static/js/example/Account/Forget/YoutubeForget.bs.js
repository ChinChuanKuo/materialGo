...
function YoutubeForget(Props) {
  ...
  if (changeBirthday !== undefined) {
    tmp.onChange = Caml_option.valFromOption(changeBirthday);
  }
  if (keydownBirthday !== undefined) {
    tmp.onKeyDown = Caml_option.valFromOption(keydownBirthday);
  }
  var tmp$1 = {
    variant: "button",
    border: "contained",
